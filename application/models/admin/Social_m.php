...
class Social_m extends CI_Model
{
    ...
    {
        $data = array(
            'social_name'   => strtoupper(stripHTMLtags($this->input->post('name', 'true'))),
        ...
        $this->db->insert('alifa_social', $data);
    }
    ...
    public function update_data()
    {
        ...
        $this->db->update('alifa_social', $data);
    }

    public function delete_data($id)
    {
        $this->db->where('social_id', $id);
        $this->db->delete('alifa_social');
    }
}
