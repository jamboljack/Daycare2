                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input type="text" class="form-control" name="name" placeholder="Input Nama Website" value="<?=$detail->meta_name;?>" autocomplete="off" required autofocus />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
$(document).ready(function() {
    ...
    $("#formInput").validate({
        ...
        messages: {
            ...
            lstRobot: { required :'Robots harus dipilih' },
            lstGoogle: { required :'Googlebots harus dipilih' }
        },
