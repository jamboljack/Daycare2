...
<script>
    function hapusData(category_id) {
        ...
        swal({
            ...
            if (!isConfirm) return;
            $.ajax({
                url : "<?php echo site_url('admin/news_category/deletedata')?>/"+id,
                type: "POST",
                dataType: "JSON",
...
$(document).ready(function() {
    table = $('#tableData').DataTable({ 
        ...
        "order": [2, 'asc'],
        "ajax": {
            "url": "<?php echo site_url('admin/news_category/data_list')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
...
$(document).ready(function() {
    ...
    $("#formInput").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: '<?=site_url('admin/news_category/savedata');?>',
                type: "POST",
                data: dataString,
                success: function(data) {
                    setTimeout(function() {
...
function edit_data(id) {
    $('#formEdit')[0].reset();
    $.ajax({
        url : "<?php echo site_url('admin/news_category/get_data/'); ?>"+id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
...
$(document).ready(function() {
    ...
    $("#formEdit").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: '<?=site_url('admin/news_category/updatedata');?>',
                type: "POST",
                data: dataString,
                success: function(data) {
                    setTimeout(function() {
