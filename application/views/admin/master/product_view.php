            ...
            <div class="col-md-12">
                ...
                <div class="portlet box grey-steel">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-edit"></i> Detail <?=$detail->menu_name;?>
                        </div>
                    </div>

                    <div class="portlet-body form">
                        <form role="form" class="form-horizontal" method="post" id="formInput" action="<?=site_url('admin/product/updatedata/'.$this->uri->segment(4));?>">
...
$(document).ready(function() {
    ...
    function sendFile(file, editor, welEditable) {
        ...
        $.ajax({
            data: data,
            type: "POST",
            url: '<?=site_url('admin/product/uploadimage');?>',
            cache: false,
            contentType: false,
            processData: false,
