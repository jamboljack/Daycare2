...
<div class="page-content-wrapper">
    <div class="page-content">
        <h3 class="page-title">Slider Utama</h3>
        <div class="page-bar">
            ...
            <div class="col-md-12">
                <div class="portlet box grey-steel">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-list"></i> Daftar Slider Utama
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $("#formInput").validate({
        ...
        messages: {
            foto: {
                required :'Gambar Slider harus dipilih'
            }
        },
...
function edit_data(id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#slider_image').val(data.slider_image);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-plus-circle"></i> Form Tambah Gambar Slider</h4>
            </div>
