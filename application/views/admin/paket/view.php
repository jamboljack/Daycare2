...
<script>
    function hapusData(paket_id) {
        ...
        swal({
            ...
            if (!isConfirm) return;
            $.ajax({
                url : "<?=site_url('admin/paket/deletedata')?>/"+id,
                type: "POST",
                dataType: "JSON",
            ...
            <div class="col-md-12">
                <div class="portlet box grey-steel">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-list"></i> Daftar Paket
                        </div>
                    </div>
                    <div class="portlet-body">
                        <a href="<?=site_url('admin/paket/adddata');?>">
...
$(document).ready(function() {
    table = $('#tableData').DataTable({
        ...
        "order": [2, 'asc'],
        "ajax": {
            "url": "<?=site_url('admin/paket/data_list');?>",
            "type": "POST"
        },
        "columnDefs": [
        {
